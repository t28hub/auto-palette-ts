...
import { ColorNameFinder } from '@internal/color/name/finder';
import { Color } from 'auto-palette';
import { beforeAll, describe, expect, it } from 'vitest';

describe('ColorNameFinder', () => {
  describe('find', () => {
    let colorNameFinder: ColorNameFinder;
    beforeAll(() => {
  ...
  describe('build', () => {
    it('should build a new ColorNameFinder instance with the provided colors', () => {
      // Arrange
      const colors = [
      ...
      // Act
      const actual = ColorNameFinder.build(colors);
